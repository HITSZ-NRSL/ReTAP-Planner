...
static const int iterations = 1500;  // work: 6, 重要参数！！
/// [m] --- Uniformly adds a padding around the vehicle
static const double bloating = 0;
/// [m] --- The width of the vehicle
static const double width = 0;  // work: 1.75 + 2 * bloating
/// [m] --- The length of the vehicle
static const double length = 0;  // work: 2.65 + 2 * bloating
/// [m] --- The minimum turning radius of the vehicle
static const float r = 0.1;  // work: 6, 重要参数！！
/// [m] --- The number of discretizations in heading
static const int headings = 36;  // work: 360/36=10, 重要参数！！
/// [°] --- The discretization value of the heading (goal condition)
static const float deltaHeadingDeg = 360 / (float)headings;  // NOLINT
/// [c*M_PI] --- The discretization value of heading (goal condition)
static const float deltaHeadingRad = 2 * M_PI / (float)headings;  // NOLINT
/// [c*M_PI] --- The heading part of the goal condition
static const float deltaHeadingNegRad = 2 * M_PI - deltaHeadingRad;
/// [m] --- The cell size of the 2D grid of the world
static const float cellSize = 0.1;  // work, unit: m, 重要参数！！
/*!
...
/// 2)
static const float penaltyReversing = 2;
...
/// false = off)
static const bool dubinsShot = true;  // 重要参数！！
...
/// first triggers
static const float dubinsShotDistance = 0.3;  //  work, unit: m. 重要参数！！

/// [m] --- The step size for the analytical solution (Dubin's shot) primarily
/// relevant for collision checking
static const float dubinsStepSize = 0.5;  //  work: 1, unit: grid. 重要参数！！
...
/// shot)
static const int dubinsWidth = 0.5;  //  work: 16
...
static const int positionResolution = 10;  //  work: 10
